...
<style type="text/css">.fancybox-margin{margin-right:17px;}</style><script type="text/javascript" charset="UTF-8" src="https://maps.gstatic.com/maps-api-v3/api/js/19/7a/common.js"></script><script type="text/javascript" charset="UTF-8" src="https://maps.gstatic.com/maps-api-v3/api/js/19/7a/map.js"></script><script type="text/javascript" charset="UTF-8" src="https://maps.gstatic.com/maps-api-v3/api/js/19/7a/util.js"></script><script type="text/javascript" charset="UTF-8" src="https://maps.gstatic.com/maps-api-v3/api/js/19/7a/marker.js"></script><script type="text/javascript" charset="UTF-8" src="https://maps.gstatic.com/maps-api-v3/api/js/19/7a/onion.js"></script><script type="text/javascript" charset="UTF-8" src="https://maps.gstatic.com/maps-api-v3/api/js/19/7a/controls.js"></script><script type="text/javascript" charset="UTF-8" src="https://maps.gstatic.com/maps-api-v3/api/js/19/7a/stats.js"></script></head>
...
<body>
    ...
    <section class="top-header">
    	<div class="wrapper topwrap">
        	<p class="top-info">Lorem ipsum dolor sit amet consetetur sadipscing elitr</p>
            
            <!--Social Media Icons-->
            <ul class="top-socialmedia">
            	<li>
                	<a href="#"><img src="images/social-media/top-social-media1.png" alt="social media"></a>
                </li>
                <li>
    ...
    <div class="wrapper">
        ...
        <header class="header-section">
            ...
            <ul class="flexy-menu vertical"><li class="showhide" style="display: none;"><span class="title">MENU</span><span class="icon"><em></em><em></em><em></em><em></em></span></li>
                <li class="active" style="display: block;"><a href="index.html">Home</a><div class="menu-space"></div>

                    <span class="indicator">+</span></li>
                <li style="display: block;"><a href="about-us.html">About Us</a><div class="menu-space"></div>

                    <span class="indicator">+</span></li>
                <li style="display: block;"><a href="services.html">Our Services</a><div class="menu-space"></div>

                    <span class="indicator">+</span></li>
                <li style="display: block;"><a href="portfolio.html">Portfolio</a><div class="menu-space"></div>

                    <span class="indicator">+</span></li>
                <li style="display: block;"><a href="#">Blog</a><div class="menu-space"></div>

                    <span class="indicator">+</span></li>
                <li style="display: block;"><a href="default_page.html">Page</a><div class="menu-space"></div>

                    <span class="indicator">+</span></li>
                <li style="display: block;"><a href="clients.html">Clients</a><div class="menu-space"></div></li>
                <li style="display: block;"><a href="contact-us.html">Contact Us</a><div class="menu-space"></div></li>
            </ul>
            <!--Navigation Menu End-->
                    ...
                    <div class="contact-area">
                        ...
                        <div class="contact-info">
                            ...
                            <ul class="contact-status fa-ul">
                            	<li>
                                	<i class="fa-li fa fa-home"></i>559 Lilac Lane Statesboro, GA 30458
                                </li>
                                <li>
                                	<i class="fa-li fa fa-tablet"></i>111-123-456-999
                                </li>
                                <li>
                                	<i class="fa-li fa fa-envelope"></i>info@yourdomain.com
                                </li>
                            </ul>
                                ...
                                <div class="footer-details">
                                    ...
                                    <div class="subscribe-box">
                                        <form>
                                            ...
                                            <input class="your-email" type="text" name="email" placeholder="Your email address *" required="">
...
<!--Google Map Script-->
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&amp;sensor=false"></script><script src="https://maps.gstatic.com/maps-api-v3/api/js/19/7a/main.js"></script>
<script>
function initialize() {
